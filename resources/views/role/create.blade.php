                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Aanmaken van gebruikers rol') }} Gebruikers Rol</h1>
                            <p class="mt-2 text-sm text-gray-700">Voeg toe {{ __('Gebruikers Rol') }}.</p>
                        </div>
